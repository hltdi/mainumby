...
#                        print("No more translations for {}".format(self))
                    ...
                    gnc = gnc[trans_index]
                    tgroups, tokens, targ_feats, agrs, t_index = zip(gna, gnc)
#                    # The token that's not a cat
                    ...
                    if self.top:
                        ...
                        t_indices.append((tgroups[1], gnc[-1]))
